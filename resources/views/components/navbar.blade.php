                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="/classrooms" :active="request()->is('classrooms')">
                                classroom
                            </x-nav-link>
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        @auth
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button class="rounded-md bg-red-600 px-4 py-2 text-white">
                                    Logout
                                </button>
                            </form>
                        @endauth
                        ...
                        @guest
                            <a href="/login"
                                class="mr-4 rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-500 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
                                Login
                            </a>
                        @endguest
